...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/My Documents/file_convert/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_2 (.A(XLXN_32[7:0]), 
                                  .B(XLXN_148[7:0]), 
                                  .EQ(XLXN_9));
   // synthesis attribute HU_SET of XLXI_2 is "XLXI_2_18"
   COMP8_MXILINX_dropfifo XLXI_3 (.A(XLXN_156[7:0]), 
                                  .B(XLXN_32[7:0]), 
                                  .EQ(XLXN_8));
   // synthesis attribute HU_SET of XLXI_3 is "XLXI_3_21"
   ...
   CB8CE_MXILINX_dropfifo XLXI_12 (.C(clk), 
                                   ...
                                   .Q(XLXN_32[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_12 is "XLXI_12_17"
   FD XLXI_18 (.C(clk), 
               .D(drop_pkt), 
               .Q(XLXN_131));
   ...
   CB8CLE_MXILINX_dropfifo XLXI_35 (.C(clk), 
                                    .CE(XLXN_136[0]), 
                                    .CLR(rst), 
                                    .D(XLXN_148[7:0]), 
                                    .L(XLXN_131), 
                                    ...
                                    .Q(XLXN_156[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_35 is "XLXI_35_19"
   FD XLXI_52 (.C(clk), 
               .D(fifowrite), 
               .Q(XLXN_136[0]));
   ...
   mem_9B XLXI_64 (.addra(XLXN_156[7:0]), 
                      .addrb(XLXN_32[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(XLXN_157[71:0]), 
